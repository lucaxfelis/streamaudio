...
CREATE TABLE Dispositivo (
    ...
    marca VARCHAR2(400) NOT NULL, 
    modelo VARCHAR2(400) NOT NULL, 
    imei  VARCHAR2(400) NOT NULL, 
    id_usuario NUMBER,
    PRIMARY KEY(id)
);
...
CREATE TABLE Album (
    id NUMBER  GENERATED BY DEFAULT AS IDENTITY, 
    nome  VARCHAR2(400) NOT NULL,
    ano_lancamento  VARCHAR2(400) NOT NULL,
    duracao  VARCHAR2(400) NOT NULL,
    faixas  VARCHAR2(400) NOT NULL,
    id_artista NUMBER,
    PRIMARY KEY(id)
);
...
CREATE TABLE Musica (
    id NUMBER  GENERATED BY DEFAULT AS IDENTITY, 
    faixa  VARCHAR2(400) NOT NULL,
    nome  VARCHAR2(400) NOT NULL,
    duracao VARCHAR2(400) NOT NULL,
    genero1  VARCHAR2(400) NOT NULL,
    genero2  VARCHAR2(400),
    id_album NUMBER,
    PRIMARY KEY(id)
);
...
CREATE TABLE Podcast (
    ...
    nome  VARCHAR2(400) NOT NULL,
    duracao  VARCHAR2(400) NOT NULL,
    data_lancamento  VARCHAR2(400) NOT NULL,
    tema1  VARCHAR2(400) NOT NULL,
    tema2  VARCHAR2(400),
    tema3  VARCHAR2(400),
    id_podcaster NUMBER,
    PRIMARY KEY(id)
...
CREATE TABLE Desconto (
    id NUMBER  GENERATED BY DEFAULT AS IDENTITY, 
    porcentagem  VARCHAR2(400) NOT NULL,
    PRIMARY KEY(id)
);
...
CREATE TABLE Usuario (
    ...
    forma_pagamento  VARCHAR2(400) NOT NULL,
    promocao  VARCHAR2(400) NOT NULL,
    tipo_plano  VARCHAR2(400) NOT NULL,
    PRIMARY KEY(id)
);
